...
const CURRENCY_CATEGORIES = [
  ...
  { label: "العملات الرقمية", currencies: ["BTC", "ETH", "DOGE", "SOL", "SHIB", "PEPE", "NEAR"] },
            ...
            <div className="text-center py-4">
              ...
              {result.fee_amount > 0 && (
                <p className="text-amber-400 text-sm mt-1">
                  - رسوم{result.fee_percentage > 0 ? ` (${result.fee_percentage}%)` : ""}: {formatFee(result.fee_amount, result.to_currency)}{" "}
                  {result.to_currency}
                </p>
              )}
            ...
            <div className="space-y-2 border-t border-[#374151] pt-3">
              ...
              <div className="flex justify-between text-sm">
                ...
                <span className="font-mono text-amber-400">
                  {result.fee_amount > 0
                    ? `${formatFee(result.fee_amount, result.to_currency)} ${result.to_currency}${result.fee_percentage > 0 ? ` (${result.fee_percentage}%)` : ""}`
                    : "بدون رسوم"}
                </span>
              </div>
